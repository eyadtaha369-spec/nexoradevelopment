...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NEXORA — Websites That Turn Visitors Into Customers" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "NEXORA — Websites That Grow Businesses" },
      {
        ...
        content:
          "Premium web development agency. We design and build conversion-focused websites for startups, enterprises, and personal brands worldwide.",
      },
